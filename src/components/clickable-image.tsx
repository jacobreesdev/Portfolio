  ...
  return (
    <span className="not-prose block">
      <button
        ...
        className="group focus:ring-primary relative block w-full cursor-zoom-in overflow-hidden rounded-xl bg-white focus:ring-2 focus:ring-offset-2 focus:outline-none dark:bg-zinc-950"
        type="button"
      >
        <Image
          src={src}
