...
<div className="not-prose mb-8 flex items-start gap-3 rounded-lg border border-amber-500/30 bg-amber-500/5 p-4 text-sm">
  <span className="mt-0.5 inline-flex shrink-0 items-center rounded-full border border-amber-500/40 bg-amber-500/10 px-2 py-0.5 text-xs font-medium tracking-wide text-amber-700 uppercase dark:text-amber-300">
    Archived
  </span>
  <div className="text-muted-foreground leading-relaxed">
    This project is no longer actively maintained. The live site has been taken
    down and no new features or bug fixes are planned.
  </div>
</div>
...
<div className="not-prose my-12">
  <CarouselStandard2
    images={[
      '/portfolio/waveger/waveger-05-homepage-desktop-thumb.webp',
      '/portfolio/waveger/waveger-05-homepage-mobile-thumb.webp',
    ]}
    alt={[
...
<div className="grid items-center gap-8 lg:grid-cols-2 lg:gap-12">
  <div className="order-1">
    <CarouselStandard2
      images={[
        '/portfolio/waveger/waveger-01-prediction-interface-desktop-thumb.webp',
        '/portfolio/waveger/waveger-01-prediction-interface-mobile-thumb.webp',
      ]}
      alt={[
...
<div className="grid items-center gap-8 lg:grid-cols-2 lg:gap-12">
  ...
  <div className="order-1 lg:order-2">
    <CarouselStandard2
      images={[
        '/portfolio/waveger/waveger-02-results-scored-desktop-thumb.webp',
        '/portfolio/waveger/waveger-02-results-scored-mobile-thumb.webp',
      ]}
      alt={[
...
<div className="grid items-center gap-8 lg:grid-cols-2 lg:gap-12">
  <div className="order-1">
    <CarouselStandard2
      images={[
        '/portfolio/waveger/waveger-04-leaderboard-desktop-thumb.webp',
        '/portfolio/waveger/waveger-04-leaderboard-mobile-thumb.webp',
      ]}
      alt={[
...
<div className="grid items-center gap-8 lg:grid-cols-2 lg:gap-12">
  ...
  <div className="order-1 lg:order-2">
    <CarouselStandard2
      images={[
        '/portfolio/waveger/waveger-06-apple-music-swap-desktop-thumb.webp',
        '/portfolio/waveger/waveger-06-apple-music-swap-mobile-thumb.webp',
      ]}
      alt={[
