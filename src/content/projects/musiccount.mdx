...
description: 'MusicCount scans your Apple Music library, groups duplicates by title and artist, and matches play counts before you clean up.'
technologies:
...
**Stack:** Swift 6.1 · SwiftUI · MediaPlayer · Swift Concurrency · Swift Testing

<div className="not-prose my-12">
  <ThemeAwareImage
    light={{
      src: '/portfolio/musiccount/musiccount-02-first-load-thumb.webp',
      lightboxSrc: '/portfolio/musiccount/musiccount-02-first-load.webp',
    }}
    dark={{
      src: '/portfolio/musiccount/musiccount-02-first-load-dark-thumb.webp',
      lightboxSrc: '/portfolio/musiccount/musiccount-02-first-load-dark.webp',
    }}
...
<div className="grid items-center gap-8 lg:grid-cols-2 lg:gap-12">
  ...
  <div className="order-1 lg:order-2">
    <ThemeAwareImage
      light={{
        src: '/portfolio/musiccount/musiccount-01-suggestions-thumb.webp',
        lightboxSrc: '/portfolio/musiccount/musiccount-01-suggestions.webp',
      }}
      dark={{
        src: '/portfolio/musiccount/musiccount-01-suggestions-dark-thumb.webp',
        lightboxSrc:
          '/portfolio/musiccount/musiccount-01-suggestions-dark.webp',
      }}
...
<div className="grid items-center gap-8 lg:grid-cols-2 lg:gap-12">
  <div className="order-1">
    <ThemeAwareImage
      light={{
        src: '/portfolio/musiccount/musiccount-comparison-light-thumb.webp',
        lightboxSrc: '/portfolio/musiccount/musiccount-comparison-light.webp',
      }}
      dark={{
        src: '/portfolio/musiccount/musiccount-comparison-dark-thumb.webp',
        lightboxSrc: '/portfolio/musiccount/musiccount-comparison-dark.webp',
      }}
      alt="Comparison view"
      loading="lazy"
      width={1920}
...
1.7 MB app size. Background queries keep large libraries responsive.
